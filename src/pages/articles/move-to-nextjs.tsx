...
export default function Page({
  ...
  const goTemplateCode = `{{ define "main" }}
  <main aria-role="main">
  ...
  return (
    <RootLayout>
      ...
      <Article>
        ...
        <Heading2>為什麼要遷移到Next.js</Heading2>
        <Heading3>Next.js是什麼？</Heading3>
        <Paragraph>
          Next.js是基於React用來快速構建網頁應用程式的開發框架，透過框架可以選擇用SSG
          (Static Site Generator)或SSR (Server Side
          Rendering)的方式渲染網頁應用程式，Next.js可以協助將整個React應用程式的目錄結構規範下來、協助簡化處理路由的細節等等，減輕React開發者的心智負擔。
        </Paragraph>
        <Heading3>學習React的契機</Heading3>
        <Paragraph>
        ...
        <Heading3>遷移到Next.js的目的</Heading3>
        <Paragraph>
          未來我想寫更多有關React技術的文章，遷移到Next.js的目的是希望能夠更方便的在文章中說明程式碼然後呈現執行結果，讓讀者可以很直觀的看到運作原理。
        </Paragraph>
        <Heading2>選擇Hugo作為SSG的優點</Heading2>
        <Heading3>構建速度極快</Heading3>
        <Paragraph>
