export default function flowPage() {
  return (
    <div className="w-full">
      <nav className="fixed my-2 top-0 w-full overflow-hidden">
        <div className="flex flex-row">
        <div className="border-2 w-1/5 justify-center">logo</div>
        <div className="flex flex-row w-full border-2 gap-4 justify-center">
          <div>item1</div>
          <div>item2</div>
        </div>
      ...
      <div className="mt-12 flex flex-row h-screen ">
        <div className="fixed w-1/3 border-2 overflow-hidden">aside</div>
        <div className="ml-72 w-full border-2 overflow-scroll">
          ---
